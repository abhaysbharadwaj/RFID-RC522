This is the arduino code along with the RFID library to read RFID card using MRC-522 RFID module.
...
you can download the DigitalIO library from: https://github.com/greiman/DigitalIO
